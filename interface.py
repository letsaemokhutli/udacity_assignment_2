...
def home():
    ...
    if request.method == 'POST':
        ...
        return render_template("index.html", data=prediction,genre_count = genre_counts,genre_bar_chart_json=genre_bar_chart_json)
    else:
        return render_template("index.html",genre_count = genre_counts,genre_bar_chart_json=genre_bar_chart_json)
